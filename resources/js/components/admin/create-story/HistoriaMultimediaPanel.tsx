...
export function HistoriaMultimediaPanel({
    ...
    const imageAreaStyle: CSSProperties | undefined = imgPreview
        ? undefined
        ...
        <div className="mt-2 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                >
                    {imgPreview ? (
                        ...
                        <FontAwesomeIcon
                            icon={faImage}
                            className="text-4xl text-[#DFE4EA]"
                        />
                    )}
                </div>
                <input
            ...
            <div className="mt-4 flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-3">
                    {galleryPreviews.map((preview, idx) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="absolute top-[2px] right-[2px] z-10 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-white opacity-0 transition-opacity group-hover:opacity-100"
                            >
                                <FontAwesomeIcon
                                    icon={faTimes}
                                    className="text-[10px]"
                    ...
                    {Array.from({
                        length: Math.max(
                            0,
                            MAX_IMAGENES_GALERIA - galeriaLength,
                        ),
                    }).map((_, i) => (
                        <div
                            key={`placeholder-${i}`}
            ...
            <div className="mt-4 flex flex-col gap-2">
                <label
                    ...
                    className="text-[13px] font-semibold text-[#1B3D6D]"
                >
                    Video (MP4/MOV)<span className="text-red-500">*</span>
                </label>
            ...
            <div className="mt-6 mb-2 flex flex-col gap-4">
                <label className="group flex cursor-pointer items-start gap-3">
                    <div className="relative mt-0.5 flex items-center justify-center">
                        <input
                            ...
                            className="peer h-4 w-4 appearance-none rounded-full border border-[#DFE4EA] text-[#1B3D6D] transition-all outline-none checked:border-[5px] checked:border-[#1B3D6D] focus:ring-[#1B3D6D]"
                        />
                    </div>
                    <div className="flex flex-col">
                        <span className="text-[14px] font-semibold text-[#1B3D6D]">
                            Activo
                        </span>
                ...
                <label className="group flex cursor-pointer items-start gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[11.5px] text-[#A0A0A0]">
                            No aparece en el sitio web pero sigue en la base de
                            datos y en la &quot;lista de historias&quot;.
                        </span>
                    </div>
                </label>
                {errors.estado && (
            ...
            <div className="mt-6 flex flex-col gap-4 border-t border-[#F3F4F6] pt-6">
                <span className="text-[13px] font-bold text-[#1B3D6D]">
                    Destacada
                </span>
                <label className="group flex cursor-pointer items-start gap-3">
                    <div className="relative mt-0.5 flex items-center justify-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[11.5px] text-[#A0A0A0]">
                            Aparece con el resto de historias según el listado
                            habitual.
                        </span>
                    </div>
                </label>
                <label className="group flex cursor-pointer items-start gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[11.5px] text-[#A0A0A0]">
                            Priorizar en portadas o bloques especiales donde se
                            muestren historias destacadas.
                        </span>
                    </div>
                </label>
                {errors.destacada && (
