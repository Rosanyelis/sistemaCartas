...
const CartDrawer: React.FC = () => {
    ...
    const handleContinueToPayment = useCallback(() => {
        if (!auth?.user) {
            if (derivedCartMode === 'subscriptions') {
                return;
            }
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <input
                        ...
                        onChange={(e) => setShippingDirection(e.target.value)}
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {view === 'cart' ? (
                                    ...
                                    {items.length === 0 ? (
                                        <div className="flex flex-col items-center gap-3 py-10 text-center">
                                            ...
                                            <p className="font-['Inter',sans-serif] text-[13px] text-[#A0A0A0]">
                                                ...
                                                desde el detalle de una
                                                historia. No se pueden mezclar
                                                ambos en el mismo carrito.
                                            </p>
                                        </div>
                                    ) : (
                                        <div className="flex flex-col gap-2">
                                                ...
                                                >
                                                    ...
                                                    <div className="flex min-w-0 flex-1 flex-col justify-between pr-10">
                                                        <div className="flex flex-col gap-0.5 pr-1">
                                                            <h3 className="font-['Inter',sans-serif] text-[14px] leading-tight font-bold text-[#1B3D6D] lg:text-[15px]">
                                                                {item.name}
                                                            </h3>
                                ...
                                >
                                  ...
                                  Antes, al cerrar el drawer tras aprobar PayPal y antes de guardar envío, se vaciaban las líneas de historia; ese estado intermedio ya no existe.
                                */}
                                            ...
                                            {!auth?.user ? (
                                                ...
                                                <>
                                                    {renderShippingForm({
                                                        ...
                                                        note: 'La suscripción recurrente con PayPal ocurre en el paso 2. Con sesión iniciada, estos datos se guardan en tu perfil al continuar.',
                                                    })}
                                                    <Button
                                                        type="button"
                    ...
                    <div className="relative z-[1] w-full max-w-[420px] rounded-[2px] border border-[#DCDCDC] bg-white p-6 shadow-[0px_12px_40px_rgba(0,0,0,0.12)] md:p-8">
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
                            <Button
                                ...
                                variant="outline"
                                onClick={handleCloseSuccessModal}
                                className="h-[44px] rounded-[2px] border-2 border-[#1B3D6D] bg-white font-['Inter',sans-serif] text-[14px] font-semibold text-[#1B3D6D] shadow-none hover:bg-[#F5F8FC] hover:text-[#1B3D6D] sm:min-w-[140px] dark:border-[#1B3D6D] dark:bg-white dark:text-[#1B3D6D] dark:hover:bg-[#F5F8FC]"
                            >
                                Cerrar
                            </Button>
                            <Button
