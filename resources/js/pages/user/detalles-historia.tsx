...
import { HistoriaHeroMedia } from '@/components/tienda/HistoriaHeroMedia';
import type { MediaItem } from '@/components/tienda/HistoriaHeroMedia';
    ...
    const handleAddSuscripcion = useCallback(() => {
        const dur =
            ...
            !Number.isNaN(historia.duracion_meses)
                ...
                : 1;
        const price = parseSubscriptionUnitPrice(
            historia.subscription_unit_price,
        );
                        ...
                        <div className="flex w-full flex-1 flex-col gap-6 lg:max-w-[624px]">
                            ...
                            <div className="flex flex-col gap-1">
                                <div className="flex flex-col items-center justify-center gap-2 rounded-[2px] bg-[#F5F5FF] py-4 lg:h-[53px] lg:flex-row lg:gap-4 lg:py-0">
                                    {(() => {
                                        const promoNum =
                                            historia.precio_promocional !== null
                                                ? Number(
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex min-w-0 flex-col gap-0.5">
                                                        ...
                                                        {desc ? (
                                                            <span className="font-['Inter',sans-serif] text-[12px] leading-snug font-normal text-[#7B7B7B]">
                                                                {
                                                                    item.description
                                                                }
                                                            </span>
                    ...
                    <section className="flex flex-col gap-10 border-b-[0.5px] border-[#F2F2F2] px-4 py-12 lg:gap-11 lg:px-[72px] lg:py-[70px]">
                        ...
                        <div className="mx-auto flex w-full max-w-[1208px] flex-col items-center gap-8">
                            <div className="relative flex w-full items-start gap-4 lg:gap-10">
                                ...
                                <div
                                    className={`relative min-w-0 flex-1 overflow-hidden font-['Inter',sans-serif] transition-all duration-500 ${!isExpanded ? 'max-h-[220px] lg:max-h-[280px]' : 'max-h-[3000px]'}`}
                                >
                                    {!isExpanded ? (
                                        <div
                                    ...
                                    <div
                                        className="prose prose-neutral max-w-none text-[15px] leading-relaxed font-normal text-[#7B7B7B] lg:text-[20px] lg:leading-[28px]"
