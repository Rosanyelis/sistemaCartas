...
@section('content')
    <p style="margin:0 0 12px 0;">Usa este código <strong>solo en nuestra web</strong> para verificar tu correo. No compartas este mensaje.</p>
    ...
    <p style="margin:12px 0 0 0;font-size:14px;color:#555555;">
        El código caduca en {{ $expiresInMinutes }} minutos. Si no creaste una cuenta, ignora este correo.
    </p>
@endsection
